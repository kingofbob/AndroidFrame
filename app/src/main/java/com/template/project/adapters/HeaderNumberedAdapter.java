...
public class HeaderNumberedAdapter extends RecyclerView.Adapter<HeaderNumberedAdapter.TextViewHolder> {
  ...
  public TextViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_main_grid, parent, false);
