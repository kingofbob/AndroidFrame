...
public class BubbleLayout extends BubbleBaseLayout {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        Log.d(BubbleLayout.class.getSimpleName(), "motion event: " + event.getAction());
        if (event != null) {
    ...
    private void playAnimationClickDown() {
        ...
        if (!isInEditMode()) {
            Log.d(BubbleLayout.class.getSimpleName(), "playAnimationClickDown");
            AnimatorSet animator = (AnimatorSet) AnimatorInflater
    ...
    private void playAnimationClickUp() {
        ...
        if (!isInEditMode()) {
            Log.d(BubbleLayout.class.getSimpleName(), "playAnimationClickUp");
            AnimatorSet animator = (AnimatorSet) AnimatorInflater
