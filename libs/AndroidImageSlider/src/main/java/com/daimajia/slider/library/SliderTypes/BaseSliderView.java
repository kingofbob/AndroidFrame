...
public abstract class BaseSliderView {
    ...
    protected void bindEventAndShow(final View v, ImageView targetImageView){
        ...
        Log.d(BaseSliderView.class.getSimpleName(), "Image check: " + mUrl);
...
//                    ((AVLoadingIndicatorView) v.findViewById(R.id.loading_bar)).hide();
//                }
//            }
...
//        });
        ...
        Glide
                .with(mContext)
                .load(mUrl)
//                    .placeholder(((AVLoadingIndicatorView) v.findViewById(R.id.loading_bar)))
                .centerCrop()
                .listener(new RequestListener<String, GlideDrawable>() {
                    @Override
                    public boolean onException(Exception e, String model, Target<GlideDrawable> target, boolean isFirstResource) {
                        Log.e(BaseSliderView.class.getSimpleName(), "bindEventAndShow", e);
                        return false;
                    }
